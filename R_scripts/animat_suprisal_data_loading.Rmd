...
first_sight <- subset_specific_run %>% select(first_sight)
...
animating_animat <- function(t, a, r) {
...
animating_animat(t = 90, a = 80, r = 80)
```
...
This should be possible via an epic for loop:
